...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  const primary = [
    ...
    { label: "Escalations", href: "/escalations", icon: Gavel },
    { label: "RTI Assistant", href: "/rti", icon: WandSparkles },
  ];
